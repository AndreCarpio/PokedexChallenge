...
export const Card = ({ pokemonName = "Sin Nombre", pokemonNumber = "#000", imageURL = "", types = [] }) => {
    return (
        <div className="pokemonCard" style={{ backgroundColor: getTypeColor(types[0]) }} >
            ...
            <div style={{ display: 'flex', flex: 2, flexDirection: 'column', justifyContent: 'flex-end', textAlign: "start" }} >
            ...
            <img src={dottedPattern} style={{ position: 'absolute', top: '2.1rem', height: "18%" }} />

            <img src={pokeballBackground} style={{ position: 'absolute', top: 0, right: 0, height: "100%" }} />

            <img src={imageURL} style={{ position: 'absolute', height: '80%', right: '-3rem' }} />
